...
Useful background for the Cynefin distinction between Clear, Complicated, Complex, and Chaotic domains.  [oai_citation:0‡Harvard Business Review](https://hbr.org/2007/11/a-leaders-framework-for-decision-making?utm_source=chatgpt.com)

NIST — “Artificial Intelligence Risk Management Framework (AI RMF 1.0).”  
A useful reference point for AI risk framing, including governance, measurement, risk tolerance, and lifecycle risk management.  [oai_citation:1‡NIST](https://www.nist.gov/itl/ai-risk-management-framework?utm_source=chatgpt.com)

Anthropic — “Building Effective Agents.”  
A practical engineering reference for agentic system design, especially the emphasis on simple, composable patterns rather than overbuilt frameworks.  [oai_citation:2‡Anthropic](https://www.anthropic.com/research/building-effective-agents?utm_source=chatgpt.com)
...
A broad survey of LLM evaluation methods, dimensions, and challenges.  [oai_citation:3‡ACM Digital Library](https://dl.acm.org/doi/10.1145/3641289?utm_source=chatgpt.com)

Zheng, L. et al. — “Judging LLM-as-a-Judge with MT-Bench and Chatbot Arena.” NeurIPS, 2023.  
A foundational paper on LLM-as-a-judge evaluation, including both its usefulness and known limitations such as position bias, verbosity bias, self-enhancement bias, and limited reasoning ability.  [oai_citation:4‡arXiv](https://arxiv.org/abs/2306.05685?utm_source=chatgpt.com)
...
Useful evidence that LLM judges may diverge from subject-matter experts in specialized domains, reinforcing the need for human expertise and bounded evaluation workflows in high-risk settings.  [oai_citation:5‡arXiv](https://arxiv.org/abs/2410.20266?utm_source=chatgpt.com)

OpenAI — “Working with Evals.”  
Official documentation describing evals as a core practice for testing model outputs against task-specific expectations, especially during model upgrades and workflow changes.  [oai_citation:6‡OpenAI Developers](https://developers.openai.com/api/docs/guides/evals?utm_source=chatgpt.com)

OpenAI — “Evals.”  
Open-source evaluation framework for building custom evaluation suites for LLM systems and workflows.  [oai_citation:7‡GitHub](https://github.com/openai/evals?utm_source=chatgpt.com)

## Embeddings, Similarity, and Negation

“Enhancing Negation Awareness in Universal Text Embeddings.” 2025.  
Relevant to the article’s argument that generic embedding similarity is often insufficient for detecting negation-sensitive logical drift.  [oai_citation:8‡arXiv](https://arxiv.org/html/2504.00584v1?utm_source=chatgpt.com)

Dasgupta, I. et al. — “Evaluating Compositionality in Sentence Embeddings.” CogSci, 2018.  
Useful background on the difficulty of representing compositional meaning and negation in sentence embeddings.  [oai_citation:9‡cocolab.stanford.edu](https://cocolab.stanford.edu/papers/DasguptaEtAl2018-Cogsci.pdf?utm_source=chatgpt.com)

Fodor, J. et al. — “The Effects of Antonymy and Polysemy.” IWCS, 2023.  
Relevant to the broader limitation of embedding spaces in distinguishing semantic opposition, antonymy, and context-sensitive meaning.  [oai_citation:10‡ACL Anthology](https://aclanthology.org/2023.iwcs-1.17.pdf?utm_source=chatgpt.com)
...
One of the closest academic references to the neuro-symbolic pattern discussed here: LLMs translate natural language into symbolic formulations, while deterministic solvers perform the reasoning step.  [oai_citation:11‡arXiv](https://arxiv.org/abs/2305.12295?utm_source=chatgpt.com)

Microsoft Research — “Z3.”  
Z3 is a widely used SMT solver for symbolic logic, software verification, program analysis, and satisfiability checking.  [oai_citation:12‡Microsoft](https://www.microsoft.com/en-us/research/project/z3-3/?utm_source=chatgpt.com)

Z3Prover — “Z3 Theorem Prover.”  
Open-source implementation and development repository for Z3.  [oai_citation:13‡GitHub](https://github.com/z3prover/z3?utm_source=chatgpt.com)

SymPy — “Logic Module.”  
Reference documentation for symbolic logic operations in SymPy, including satisfiability checking for Boolean expressions.  [oai_citation:14‡docs.sympy.org](https://docs.sympy.org/latest/modules/logic.html?utm_source=chatgpt.com)

## Structured Outputs and Practical Control Surfaces

OpenAI — “Structured Outputs.”  
Official documentation for constraining model outputs to match supplied JSON Schemas, a practical building block for structured parsing and downstream validation.  [oai_citation:15‡OpenAI Developers](https://developers.openai.com/api/docs/guides/structured-outputs?utm_source=chatgpt.com)

Microsoft Azure OpenAI — “Structured Outputs.”  
Useful reference for structured outputs in enterprise/cloud deployments, including schema-constrained generation for multi-step workflows.  [oai_citation:16‡Microsoft Learn](https://learn.microsoft.com/en-us/azure/foundry/openai/how-to/structured-outputs?utm_source=chatgpt.com)
