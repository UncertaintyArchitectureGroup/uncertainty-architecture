...
This matrix is the canonical repository record for material source-to-framework decisions. It is a synthesis aid, not a mandatory ledger for every sentence. Material research items that are still under active investigation are tracked separately in the [`Research State Register`](research-register.md); this file records their relationship to framework decisions when that relationship is material.
