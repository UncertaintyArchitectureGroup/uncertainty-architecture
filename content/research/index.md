...
For the current Thinking Systems research line, the more specific recorded provenance is that the formulation **“Thinking Systems”** entered the work through Vitalii Oborskyi's exchange with **Arkadiy Dobkin** following Dobkin's public *From Fall to Rise* LinkedIn post. That provenance concerns the formulation and research prompt, not authorship of the UA-specific definition, the Consequential Runtime Responsibility boundary, the control-capability model, or the resulting paper. Acknowledgment of the exchange does not imply Dobkin's endorsement or agreement with UA.
