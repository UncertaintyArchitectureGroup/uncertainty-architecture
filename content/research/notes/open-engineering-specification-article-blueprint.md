...
- the four decision horizons, the paper-level assessment-eligibility / Project-viability / Organizational-selected-path-and-business-or-research-authorization / scoped-Project-Authorization handshake, Project-selected-design category exit, and reassessment routing with exogenous Organizational change separated from lower-level evidence;
...
- validation of the assessment-eligibility / Project-viability / Organizational-specific-research/business/basis / scoped-Project-Authorization lifecycle refinement, including Project-selected-design category exit and exogenous Organizational change routing;
...
- Figure 11 — Project control architecture, viability conclusion, Organizational choice, Project-selected-design category exit, and research-only/production-capable authorization handshake;
