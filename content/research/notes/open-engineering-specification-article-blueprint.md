...
- Explain that governance becomes operational through the complete socio-technical control architecture formed by the capability families across the expanded control perimeter. Defer the canonical decision-level labels, sequence, and ownership model to Section 5.4.
...
**Working word budget:** 1,650–2,050  <!-- reconciled against current Section 3 (~1,850 words) -->
