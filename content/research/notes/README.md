...
- [`open-engineering-specification-article-blueprint.md`](open-engineering-specification-article-blueprint.md) — active, incomplete editorial skeleton for the canonical public synthesis article. It remains a non-normative working document; its structure has not yet passed Phase 1 architecture, logic, technical, and editorial review.
- [`open-engineering-specification-article-phase-1-plan.md`](open-engineering-specification-article-phase-1-plan.md) — completion plan and exit criteria for reducing the working blueprint to an accepted, drafting-ready editorial contract before any Phase 2 prose is treated as stable.
