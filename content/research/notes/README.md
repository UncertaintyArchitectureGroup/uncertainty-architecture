...
- [`open-engineering-specification-article-blueprint.md`](open-engineering-specification-article-blueprint.md) — drafting-ready editorial contract proposed for Phase 1 acceptance of the public synthesis article. It uses one unnumbered abstract, eight numbered sections, three figures, and one illustrative continuous Constraint trace while remaining non-normative research material.
- [`open-engineering-specification-article-phase-1-completion.md`](open-engineering-specification-article-phase-1-completion.md) — Phase 1 completion-candidate record documenting architecture, logic, technical, metadata, repository, and editorial decisions while preserving the pending maintainer freeze before article drafting begins.
