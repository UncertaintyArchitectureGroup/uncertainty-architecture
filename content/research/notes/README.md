...
- [`thinking-systems-public-review-2026-09.md`](thinking-systems-public-review-2026-09.md) — source-linked September 2026 intake of public recognition and substantive review, including Dobkin's separately testable economic extensions (`TS-ECON-001`, `TS-ECON-002`), category counterexamples, harness substitution and human-review evidence. It separates verified public observations, earlier provenance and remaining source/permission gaps without changing the published article or specification.
...
- [`open-engineering-specification-article-blueprint.md`](open-engineering-specification-article-blueprint.md) — active living editorial contract for the long-form public synthesis paper. It preserves the complete argument, section responsibilities, running-example contract, figure plan, source plan, maturity boundaries, writing notes, and unresolved editorial decisions while remaining non-normative research material.
