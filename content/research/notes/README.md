...
- [`thinking-systems-public-review-2026-09.md`](thinking-systems-public-review-2026-09.md) — source-linked September 2026 public-feedback intake, including Dobkin's candidate economic propositions, category counterexamples, harness substitution and human-review evidence leads. It separates bounded public observations, possible research relevance, earlier provenance and remaining source/permission gaps without changing research state, the published article or specification.
...
- [`thinking-systems-publication-draft.md`](thinking-systems-publication-draft.md) — frozen publication authoring source for *Uncertainty Architecture: Thinking Systems — When the Controlled Object Changes*. Its preserved repository edition is [`../publications/thinking-systems-when-the-controlled-object-changes.md`](../publications/thinking-systems-when-the-controlled-object-changes.md); future substantive research development continues in the living long-form manuscript. It preserves the category and controlled-object deduction from the long-form §§1–2, follows the manuscript's closed-loop → complete bounded-control figure sequence through Figures 6–7, and aligns publication Figure 8 with the manuscript's orthogonal model: assessment eligibility, Project-owned technical selection and category confirmation, category exit, specific research/business authorization, scoped research-only or production-capable Project Authorization, reassessment routing, and the independent capability-family axis remain visible while later operating detail stays compressed. It exposed that bounded argument to external criticism while the larger paper remained under development.
- [`thinking-systems-platform-renditions.md`](thinking-systems-platform-renditions.md) — distribution profile for equivalent Medium and LinkedIn renditions of the current Thinking Systems content edition, including platform constraints, canonical-link handling, reviewed-asset reuse, alt-text rules, and the boundary between formatting adaptation and conceptual change.
- [`thinking-systems-linkedin-launch-post.md`](thinking-systems-linkedin-launch-post.md) — copy source for the LinkedIn launch post, preserving Arkadiy Dobkin formulation credit, full Taller dialogue attribution, the agent-mediated workflow reflection, and the invitation to challenge or simplify the framework.
