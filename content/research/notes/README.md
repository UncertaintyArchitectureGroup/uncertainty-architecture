...
- [`open-engineering-specification-article-phase-1-completion.md`](open-engineering-specification-article-phase-1-completion.md) — Phase 1 completion record documenting the architecture, logic, technical, metadata, and editorial decisions and the remaining maintainer freeze before article drafting begins.
