...
- [`ai-delivery-lifecycle.md`](ai-delivery-lifecycle.md) — an early lifecycle hypothesis reclassified from doctrine. Parts of its readiness, completion, release, responsibility, and lightweight-artifact questions have now been translated into the Thinking System Review; remaining questions concern evidence proportionality, control economics, incident learning, and reassessment cadence.
