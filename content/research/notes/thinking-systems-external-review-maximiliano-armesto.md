...
| The socio-technical control perimeter and organizational decision reach overlap materially with **[STAMP/STPA](https://psas.scripts.mit.edu/home/get_file.php?name=STPA_handbook.pdf)**. | The paper now acknowledges that hierarchical socio-technical control extending into management and regulatory authority is established antecedent territory. The narrower candidate contribution is whether the four-horizon model adds practitioner value for model-judgment-dependent software by explicitly separating ownership of technical viability, business and authority authorization, release scope, runtime correction, and reassessment when the basis of operation becomes invalid. | This contribution claim must be demonstrated, narrowed, or rejected through comparison; it is not assumed as novelty. |
...
**Existing comparative scope preserved.** Before this review, the blueprint already planned a broad, bidirectional analysis across STAMP/STPA, Simplex/runtime assurance, mathematical and control-theoretic work, production ML/software engineering, risk and AI management systems, and implementation approaches and platforms. The review changes the timing and directness of the STAMP/STPA positioning in the standalone article; it is not treated as the source of that broader research plan.
...
3. Does explicitly separating ownership of technical viability, business and authority authorization, release scope, runtime correction, and reassessment provide practitioner value beyond a well-applied STAMP/STPA control structure or another credible composition?
