...
PR #114 has merged. PR 3 integrates the operational agent route and a reproducible preflight corpus, adds workflow/trust-boundary regressions, and records live connector transport. The initial lexical baseline misses two Ukrainian-only queries; explicit source-grounded retries recover their owners. Independent blind cold-start assessment remains open, and measured byte counts do not establish a productivity gain.
