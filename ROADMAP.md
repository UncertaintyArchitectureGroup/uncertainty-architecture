...
The [bounded initial comparison](.github/tests/repository_intelligence/AB-EVALUATION.md) uses 12 independently selected real tasks / 24 fresh sessions, ordinary live-GitHub Control and normal optional compact-context Treatment. Protocol v11 keeps same-state/isolation checks, blind scoring and measured costs while reducing evidence to study, runs and scores; the evaluator generates source-pinned bootstrap messages, self-contained blind scoring packets and four-outcome reports. It replaces the unexecuted v10 two-wave design. PR #119 has merged. The [separate experiment record](.github/tests/repository_intelligence/studies/2026-09-17-initial/README.md) retains two unscored rehearsals and incomplete/redacted ChatGPT connector evidence. The maintainer confirmed setup and approved the narrower descriptive comparison: 12 assistant-prepared tasks / 24 fresh sessions, frozen prompts and expectations, one prompt at a time, and independent scoring after collection. Auto model parity, source/delivery evidence and Memory-disabled compliance are not inferred from approval; missing measurements remain unavailable. This study cannot establish a valid v11 benefit/cost verdict. Descriptive collection is paused after six received attempts while the maintainer waits for model availability. One explicitly requested supplemental T03/B retry is planned with the same frozen prompt; the original refusal remains unchanged and the follow-up is reported separately. Independent scoring remains pending. Full RI-EVAL scenario acceptance remains open; any follow-up uses a separate frozen decision-specific study.
