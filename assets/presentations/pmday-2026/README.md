...
- 16:9, 1280×720 design canvas; одна узгоджена сітка з полями 48 px.
...
- Заголовки переважно 42 px (31,5 pt); головний текст 28–34 px; великі числа 48–66 px; щільні evidence labels 22–24 px; джерела 16–18 px. Не приховувати substantive caveats у мікрошрифті.
...
- Після кожної збірки: structural/editability checks, freshness hashes, render усіх 14 слайдів і огляд кожного. Валідатор не доводить visual quality.
...
```pptx-slide
{
  ...
  "nberCaveat": "Cumulative estimates. Separate async release effect not identified.",
  "marketHeadline": "More apps. No aggregate usage increase.",
  ...
  "cards": [
    ...
    [
      "XU + AGARWAL · 2026 VERSIONS",
      "Complexity +35% / +43%",
      "Agent-first / IDE-first; workload shifts"
    ]
  ],
...
```pptx-slide
{
  ...
  "watch": "Complexity / volume / duplication / reuse / ownership",
  "explore": "SDD / living architecture docs / repository intelligence",
