...
```pptx-slide
{
  ...
  "nberGeneration": "Three tool generations · rounded Fig. 1",
  "nberCaveat": "Changed LOC = additions + deletions.\nAsync release effect not estimated.",
  "marketHeadline": "New apps with little early usage",
  ...
  "gitclearCaveat": "Refactoring / connectivity proxies.\nDifferent baselines for secondary signals.*",
  "otherCards": [
    [
      "METR · MAY 2026",
      "1.4–2× work value",
  ...
  "doraInterval": "89% credible interval\n≈ +0.07 to +0.13 SD",
  "doraMeasures": "Survey association, not a causal estimate.\nSD is not a failure percentage.",
...
```pptx-slide
{
  ...
  "table": [
    [
      "CONTRACT",
      "TRADITIONAL DoR / DoD",
      "IT ASSISTANT: ADDED REQUIREMENTS"
    ],
    [
      "DoR\nREADY",
      "Outcome and acceptance criteria\nDependencies and feasibility\nTest approach and responsibilities",
      "Approved guidance + prohibited outcomes\nEvaluation, controls and human-response plan\nCost, latency and capacity limits"
    ],
    [
      "DoD\nDONE",
      "Reviewed implementation\nTests and acceptance checks pass\nOperational handover is ready",
      "Versioned evidence meets evaluation criteria\nPermission checks + rehearsed support fallback\nMeasured cost, latency and responder capacity"
    ]
  ],
  "caption": "DoR is a team practice. DoD is a shared quality commitment. Release requires authorization.",
  ...
  "behavior": "IT assistant: the observed privacy breach blocks this candidate.",
...
```pptx-slide
{
  "number": 13,
  "layout": "roles",
  "role": "PROJECT MANAGER · coordinates Product / PO, BA, engineering, QA and operations",
  "steps": [
    "Hypothesis",
    "Bounded trial",
    "Evidence",
  ...
  "table": [
    ...
    [
      "Expertise + ownership",
      "Qualified reviewer and recovery owner\nLearning time for unfamiliar code",
      "Agreed criteria and a domain reviewer\nNamed responder with verified capacity"
    ],
    [
      "Evidence + flow",
      "Review queue, rework and batch size\nEvidence the team can maintain the code",
      "Useful resolutions and error severity\nEvaluation and control evidence"
    ],
    [
      "Decision dependencies",
      "Training, staffing or narrower scope\nbefore the dependency becomes critical",
      "Unmet criteria or missing capacity\nblocks the release decision"
    ]
  ],
