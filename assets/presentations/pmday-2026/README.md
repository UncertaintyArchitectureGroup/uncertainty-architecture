...
```pptx-slide
{
  ...
  "architectureHeading": "ARCHITECTURE ALSO OWNS",
  "architecture": [
    "Provider changes and isolation",
    "Human response capacity",
    "Fallible semantic checks"
  ],
