...
```pptx-slide
{
  ...
  "takeaway": "Engineer the useful region: define → evaluate → control → operate.",
  ...
  "role": "THINKING SYSTEMS · affects product, delivery, engineering and operations"
}
```
...
```pptx-slide
{
  ...
  "roleDetail": "Product / PO: value + backlog priorities.\nBA: examples + acceptance rules.\nProject Manager: decisions + dependencies.",
  ...
  "takeaway": "One behavior contract connects product value, delivery and release.",
...
```pptx-slide
{
  "number": 10,
  "layout": "evaluation",
  "role": "QA + DEVELOPERS · DOMAIN EXPERTS · PRODUCT / PO · PROJECT MANAGER",
  ...
  "instruments": "Golden Set probes scenarios; representative samples estimate rates. Eval Gates compare versions.",
  "calibration": "QA + domain experts calibrate judgments. Production incidents become regression cases.",
  "chartCategories": [
    "Acceptable",
    "Incorrect steps",
    "Privacy leak"
  ...
  "ownershipLine": "Product / PO + BA: limits · Project Manager: readiness · Authorized owner: release"
}
```
...
```pptx-slide
{
  "number": 11,
  "layout": "risk",
  "role": "PRODUCT OWNER + BA · DEVELOPERS + QA · PROJECT MANAGER · OPERATIONS",
  "table": [
    [
      "CONTRACT",
      "TRADITIONAL DoR / DoD",
    ...
    [
      "DoR\nREADY",
      "Outcome and acceptance criteria\nDependencies and feasibility\nTest approach and responsibilities",
      "Acceptable variation + prohibited outcomes\nEvaluation plan + complete control / HITL design\nCost, latency and human-capacity limits"
    ],
    [
      "DoD\nDONE",
      "Reviewed implementation\nTests and acceptance checks pass\nOperational handover is ready",
      "Versioned evidence + statistical Eval Gates\nCoverage, uncertainty and measured limits\nWorking controls + rehearsed human / fallback paths"
    ]
  ],
  "caption": "DoR: a team practice. DoD: a shared quality commitment. Release: a separate authorized decision.",
  "takeaway": "Ready: a credible plan. Done: implemented and evidenced. Release: authorized use.",
  ...
  "behavior": "Shared readiness and completion; the authorized release owner decides when and where to launch.",
  "releaseHeading": "RELEASE OWNER: AUTHORIZE · SERVICE OWNER: OPERATE",
  "release": "Approve scope and residual risk; verify responder capacity, monitoring and rollback ownership.",
  "incident": "Production incidents update regression cases, Eval Gates and monitoring rules."
}
```
...
```pptx-slide
{
  "number": 12,
  "layout": "control",
  "role": "ARCHITECT + DEVELOPERS · QA · SERVICE OWNER / OPERATIONS · PROJECT MANAGER",
  "steps": [
    "Approved context",
    "Model proposal",
    "Permission gate",
  ...
  "humanDetail": "Competence + response time\nPeak capacity + backup",
  ...
  "perimeterHeading": "COMPLETE CONTROL PERIMETER",
  "core": "Model + tools\nBusiness action",
  ...
  "vetoAction": "Narrow, redesign or reject this AI path.",
...
```pptx-slide
{
  "number": 13,
  "layout": "roles",
  "role": "PROJECT MANAGER · connects Product / PO, BA, engineering, QA and operations",
  "steps": [
    "Hypothesis",
    "Bounded trial",
    "Evidence",
  ...
  "table": [
    ...
    [
      "Expertise + ownership",
      "New stack, reviewer coverage,\nunderstanding and recovery capability",
      "Product / PO, BA, QA, Dev, Architect,\nservice owner and responders"
    ],
    [
      "Evidence + flow",
      "Review load, rework and batch size\nLearning and dependency validation",
      "Business value, severity and uncertainty,\neval quality and control effectiveness"
    ],
    [
      "Decision dependencies",
      "Prototype growth needs reassessment\nTraining / staffing / scope decision",
      "Limits → evidence → controls → release\nNamed owners, capacity and stop rules"
    ]
  ],
  "takeaway": "Working code, team competence and operating readiness must develop together.",
  ...
  "foundation": "Scope, schedule, cost, risk and stakeholders remain the foundation.",
  "statisticalLiteracy": "Statistical literacy: question the sample, uncertainty, thresholds and decision evidence.",
  "roleBoundary": "Project Manager coordinates decisions. Product, technical and risk owners retain authority.",
  "caseHeading": "A KNOWLEDGE GAP CAN BECOME A DELIVERY DEPENDENCY",
  "caseSteps": [
    "AI adds code in a language\nthe team does not know",
    "A small component grows\ninto a critical dependency",
    "No qualified review\nNo one can recover it"
  ],
  "caseAction": "Project Manager secures an owner, time and closure evidence before criticality grows."
}
```
...
```pptx-slide
{
  ...
  "takeaway": "Start with one workflow: value target, limits, evidence, owner and rehearsed fallback.",
  ...
  "factoryDetail": "Working increments, commitments\nand operational ownership.",
  "labHeading": "THE LABORATORY STAYS OPEN",
  "labDetail": "Each material change reopens\na hypothesis and its evidence.",
  "labSteps": [
    "Hypothesis\n+ approved limits",
    "Bounded\nexperiment",
    "Measure\n+ compare",
  ...
  "applications": [
    [
      ...
      "Measure flow, review, rework and retained understanding."
    ],
    [
      "WHAT: Thinking Systems",
      "Measure useful outcomes, behavior, control capacity and full cost."
    ]
  ],
  "teamHeading": "SHARED OPERATING MODEL · Project Manager coordinates dependencies and decisions",
  "ceremonies": [
    [
      "PLANNING",
