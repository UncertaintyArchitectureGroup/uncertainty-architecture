...
```pptx-slide
{
  "number": 11,
  "layout": "risk",
  "role": "DEVELOPERS + QA · readiness and completion need stronger evidence",
  "table": [
    [
      "CONTRACT",
      "TRADITIONAL DoR / DoD",
  ...
  "caption": "Cost is part of readiness and verified limits. Completion and release remain distinct decisions.",
  ...
  "behavior": "The same two questions: are we ready to start, and have we completed the work?",
  "releaseHeading": "RELEASE AND OPERATE",
  "release": "Approve evidence, residual risk and rollout scope. Keep monitoring and responders active.",
...
```pptx-slide
{
  "number": 12,
  "layout": "control",
  "role": "ARCHITECT · the system includes control, people and recovery",
  "steps": [
    "Approved context",
    "Model proposal",
    "Permission gate",
  ...
  "takeaway": "A feedback arrow is insufficient. The complete control path must work.",
  ...
  "humanDetail": "Response time + peak capacity\nBackup coverage",
  ...
  "human": "HUMAN AUTHORITY\nContext + competence + real decision rights",
...
```pptx-slide
{
  "number": 13,
  "layout": "roles",
  "role": "PROJECT MANAGER · understand the changed system of work",
  "steps": [
    "Hypothesis",
    "Bounded trial",
    "Evidence",
  ...
  "roleBoundary": "PM connects specialists and makes gaps actionable. Domain owners keep their decisions.",
  ...
  "caseAction": "PM tracks the gap, its owner and closure evidence before criticality grows."
}
```
...
```pptx-slide
{
  ...
  "takeaway": "The experiment ends. Learning, monitoring and reassessment continue.",
  ...
  "applications": [
    ...
    [
      ...
      "Measure behavior, control capacity and operating cost."
    ]
  ],
  "teamHeading": "THE TEAM’S OPERATING MODEL",
  "ceremonies": [
    [
      "PLANNING",
      "Question + owner\nEvidence + stop rule"
