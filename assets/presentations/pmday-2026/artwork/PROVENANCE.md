...
## Closing QR codes, 23 September 2026

Requested machine-readable links, not decorative imagery. Generated deterministically with the primary runtime’s ReportLab QR encoder (byte data, error correction M, four-module white quiet zone), exported as lossless PNG with integer module scaling. Their meaning is the exact URL, not an AI-generated pattern. Native links and printed destinations accompany the images.

- [qr-ua.png](qr-ua.png): https://github.com/UncertaintyArchitectureGroup/uncertainty-architecture; SHA-256 `f4039e8fc6b51dbdf09cd87d88dcb182e8b458505d6ee14db052171ca7b6d154`.
- [qr-subprime.png](qr-subprime.png): https://github.com/UncertaintyArchitectureGroup/The-Subprime-Code-Crisis; SHA-256 `e1dbc72048352c901ac612bb403f57c32fdbbe787fea1c7c243c55858cf71db7`.
