...
>
> **Explore:** [Doctrine](../00-doctrine/) · [Patterns](../01-patterns/) · [Control capabilities](../02-ai-control-plane/) · [Reference architectures](README.md) · [Failure modes](../04-failure-modes/) · [Research](../content/research/index.md)
...
Reference architectures make abstract responsibilities visible: where Model Judgment occurs, which deterministic responsibilities surround it, which Constraints define the operating space, how their realizations make the boundary operational, how Sensors expose behavior and control health, who or what acts as Controller, which Actuators can change operation, how project and delivery decisions connect, and how failure is contained.
...
- possible distributions of the four capability families;
...
5. the scoped Constraint claims and concrete realizations, including failure behavior;
6. relevant Sensors and evidence;
7. the Controller and decision authority, including Constraint and realization change authority;
...
A reference must not use one mixed hard/soft record when different subjects, paths, or scopes have different guarantee strength.
...
- [`judgment-placement-examples.md`](judgment-placement-examples.md) — reference architectures showing isolated and composite placement classes with Constraints, realizations, deterministic responsibilities, authority, evidence, corrective action, fallback, risks, and review focus.
- [`worked-thinking-system-review-support-triage.md`](worked-thinking-system-review-support-triage.md) — completed illustrative delivery review covering three Judgment Nodes, bounded experimentation, scoped Constraint claims, one realization map, full DoR and DoD decisions, residual risk, a human-supervised Release Gate, runtime control, and framework-application observations.

Individual reference architectures should declare `status: reference` and follow [`DOCUMENT-METADATA.md`](../DOCUMENT-METADATA.md).

## Relationships

- [`00-doctrine/control-loop-anatomy.md`](../00-doctrine/control-loop-anatomy.md) defines the four logical capability families.
...
- [`02-ai-control-plane/`](../02-ai-control-plane/) provides the capability-family model used in compositions.
- [`02-ai-control-plane/01-constraints/`](../02-ai-control-plane/01-constraints/) provides the composite Constraints family and implementation-oriented catalog.
