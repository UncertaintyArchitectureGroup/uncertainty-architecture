...
REQUIRED_CASE_NAMES: Set[str] = {
    ...
    "NUL-safe changed path regression deletion is rejected",
    "formatter alias-safety regression deletion is rejected",
    "Prettier baseline deletion is rejected",
    "Prettier generated-output ignore deletion is rejected",
    "Prettier semicolon baseline drift is rejected",
    "publication-impact detector deletion is rejected",
    "publication-impact regression suite deletion is rejected",
    "publication-impact workflow routing deletion is rejected",
