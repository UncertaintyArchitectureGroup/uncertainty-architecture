...
The [initial experiment record](studies/2026-09-17-initial/README.md) preserves post-#119 rehearsals and the maintainer-approved descriptive comparison, with 12 tasks / 24 messages frozen before outcomes. That narrower study does not meet the [v11 protocol](AB-EVALUATION.md)'s full evidence prerequisites and cannot establish its RI-benefit/cost verdict. Collection is paused for reported model availability; a maintainer-requested supplemental retry is planned without replacing the original attempt. Independent scoring remains pending.
