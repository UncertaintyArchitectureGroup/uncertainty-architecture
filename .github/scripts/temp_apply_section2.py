...
### 5.3 From Model Quality to Bounded Control'''
if 'Accepted drafting decisions from the 2026-08-12 Section 2 iteration' not in b:
    if marker not in b:
        raise SystemExit('Blueprint anchor not found')
    b = b.replace(marker, decisions, 1)
