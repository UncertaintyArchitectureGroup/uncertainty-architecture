...
- Added a research publication-adaptation cycle for exposing a bounded standalone article before completion of a larger living paper when early external criticism can improve the remaining research. The workflow keeps the blueprint/long-form manuscript as the owning pair, develops the shorter adaptation under `content/research/notes/`, routes material feedback back into the owning research, and preserves the externally published edition under `content/research/publications/`. The first adaptation, *Thinking Systems: From Model Judgment to Bounded Control*, records explicit provenance for the `Thinking Systems` formulation through Vitalii Oborskyi's exchange with Arkadiy Dobkin while separating that provenance from the UA-specific engineering definition and from endorsement or co-authorship.
