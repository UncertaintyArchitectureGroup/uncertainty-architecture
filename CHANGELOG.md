...
- Added a research publication-adaptation cycle for exposing a bounded standalone argument before completion of a larger living paper when early external criticism can improve the remaining research. The workflow keeps the blueprint/long-form manuscript as the owning pair, develops the shorter adaptation under `content/research/notes/`, routes classified material feedback back into the owning research, and treats one substantive **content edition** as the preserved publication record with equivalent Medium, LinkedIn, website, or other copies recorded as platform renditions. Immediately after publication, the exact content edition is preserved under `content/research/publications/` with publication URLs and an immutable source identity before feedback-driven reconciliation; later substantive changes require a new edition or an explicit material-transformation record. The first adaptation, *Thinking Systems: When the Controlled Object Changes*, preserves the full category/controlled-object deduction, compresses the later bounded-control and lifecycle detail around the socio-technical control-perimeter thesis, and records explicit provenance for the `Thinking Systems` formulation through Vitalii Oborskyi's exchange with Arkadiy Dobkin while separating that provenance from the UA-specific engineering definition and from endorsement or co-authorship.
